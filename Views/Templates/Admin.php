            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-dark py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo BASE_URL; ?>administrador/">Repartidores</a>
                        <a class="collapse-item" href="<?php echo BASE_URL; ?>administrador/proveedores">Proveedores</a>
                        <a class=" collapse-item" href="<?php echo BASE_URL; ?>administrador/plantas">Plantas</a>
